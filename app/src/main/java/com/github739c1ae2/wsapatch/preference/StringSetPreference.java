...
public class StringSetPreference extends ActivityPreference {

    private HashSet<String> mDefaultValue;

    public StringSetPreference(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected Class<? extends ActivityPreferenceActivity> getActivityClass() {
        return StringSetPreferenceActivity.class;
    }
}
